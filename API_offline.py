...
out_box.insert(END,"Hello! How are you doing  today? I am Tam's assistant! I can help you save time, energy and money by summarizing \ndocuments for you without internet connection and no fee in local mode, or friendly chat with you and provide you a fantastic summary in API mode. Please start a chat with me by typing your words after 'User:', or enter a desired number of (sentences) words for a summary into the top right corner box, then click the 'Upload a File' button in the bottom-right to upload a \ndocument for summary! ")
out_box.insert(END,"\nUser: ",'tag1')
